types = ['german', 'japanese', 'vegetarian', 'vegan', 'french', 'african', 'american', 'barbecue', 'czech', 'chinese', 'thai',
...
restaurant_data = [['german', "Esther's German Saloon", '3', '3', '22 Teutonic Ave.'],
                   ...
                   ['vegan', "Sally's Diner", '4', '3', '96 College Blvd.'],
                   ...
                   ['vegan', 'The Whole Tamale', '2', '4', '401 University'],
                   ...
                   ['vegan', 'Zardoz Cafe', '4', '2', '6202 Alameda'],
